...
namespace MakkajaiSalesTax.Repository
{
    public class SalesTaxImplementation : ISalesTax
    {
        private volatile static ISalesTax uniqueInstance;
        private SalesTaxImplementation() { }
        public void countSalesTax()
        {
            try
            {
                ...
                for (int i = 0; i < mSalesItems.Count; i++)
                {
        ...
        public static ISalesTax getApi()
        {
            return getISalesTax();
        }
